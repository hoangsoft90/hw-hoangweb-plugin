 ...
 * Nav menu admin
 */
if(!class_exists('Menu_Icons_Admin_Nav_Menus')) :
final class Menu_Icons_Admin_Nav_Menus {
	...
	public static function init() {
		...
		#add_filter( 'wp_edit_nav_menu_walker', array( __CLASS__, '_filter_wp_edit_nav_menu_walker' ), 99 );    //disable by hoangweb
	 ...
	 *
	 * @since  0.1.0
	 * @access protected (modified to public by hoangweb)
	 * @uses   apply_filters() Calls 'menu_icons_types' on returned array.
	 *
	 * @return array
	 */
	public static function _get_types() {
		$types = array_merge(
			array(
				'' => array(
					'id'    => '',
	 ...
	 *
	 * @since  0.3.0
	 * @access private (modified to public scope by hoangweb)
	 * @return array
	 */
	public  static function _get_fields( Array $values = array() ) {
	...
	public static function _fields( $id, $item, $depth, $args ) {
        ...
        do_action( 'menu_icons_before_fields_', $item, $depth, $args, $id );    //test by hoangweb
		?>
