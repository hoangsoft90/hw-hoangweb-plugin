...
if ( ! class_exists( 'Menu_Item_Custom_Fields' ) ) :
	...
	*/
	class HW_Menu_Item_Custom_Fields {
		...
		*/
		public static function _filter_walker( $walker ) {
			$walker = 'HW_Menu_Item_Custom_Fields_Walker';
	...
	add_action( 'wp_loaded', array( 'HW_Menu_Item_Custom_Fields', 'load' ), 9 );
endif; // class_exists( 'Menu_Item_Custom_Fields' )

// Uncomment the following line to test this plugin
require_once dirname( __FILE__ ) . '/menu-item-custom-fields-render.php';
