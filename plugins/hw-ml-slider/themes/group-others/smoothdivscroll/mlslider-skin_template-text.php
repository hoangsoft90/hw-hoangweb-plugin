...
$theme['styles'][] = 'asset/style-text.css';
?>
<div class="slider-wrapper theme-default">
    <div id="makeMeScrollable-<?php echo $slider_id?>" class="hw-smoothdivscroll scrollingText" >
...
<script type="text/javascript">
    jQuery(document).ready(function ($) {
        $("#makeMeScrollable-<?php echo $slider_id?>").smoothDivScroll(<?php echo $options?>);
        <?php if(!empty($user_theme_options['pause_on_hover']) && $user_theme_options['pause_on_hover']){?>
        // Mouse over
