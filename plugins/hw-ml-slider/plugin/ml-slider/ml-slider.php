 ...
 * Class hw_metaslider
 */
if(!class_exists('hw_metaslider')):
class hw__metaslider{
    /**
     * @var
     */
    static $object = null;
    ...
    /**
     * create singleton slider class
     */
    public static function init(){
        if(empty(self::$object)) self::$object = HW_MetaSliderPlugin::init();
        return self::$object;
    }
}
endif;
if ( ! class_exists( 'HW_MetaSliderPlugin' ) ) :
...
class HW_MetaSliderPlugin {
    ...
    private function define_constants() {
        ...
        define( 'HW_METASLIDER_VERSION',    $this->version );
        define( 'HW_METASLIDER_BASE_URL',   trailingslashit( plugins_url( '',__FILE__ ) ) );
        define( 'HW_METASLIDER_ASSETS_URL', trailingslashit( HW_METASLIDER_BASE_URL . 'assets' ) );
        define( 'HW_METASLIDER_PATH',       plugin_dir_path( __FILE__ ) );
    ...
    private function plugin_classes() {
        ...
        return array(
            'hw_metaslider'            => HW_METASLIDER_PATH . 'inc/slider/metaslider.class.php',
            'hw_metacoinslider'        => HW_METASLIDER_PATH . 'inc/slider/metaslider.coin.class.php',
            'hw_metaflexslider'        => HW_METASLIDER_PATH . 'inc/slider/metaslider.flex.class.php',
            'hw_metanivoslider'        => HW_METASLIDER_PATH . 'inc/slider/metaslider.nivo.class.php',
            'hw_metaresponsiveslider'  => HW_METASLIDER_PATH . 'inc/slider/metaslider.responsive.class.php',
            'hw_metaslide'             => HW_METASLIDER_PATH . 'inc/slide/metaslide.class.php',
            'hw_metaimageslide'        => HW_METASLIDER_PATH . 'inc/slide/metaslide.image.class.php',
            'hw_metasliderimagehelper' => HW_METASLIDER_PATH . 'inc/metaslider.imagehelper.class.php',
            'hw_metaslidersystemcheck' => HW_METASLIDER_PATH . 'inc/metaslider.systemcheck.class.php',
            'hw_metaslider_widget'     => HW_METASLIDER_PATH . 'inc/metaslider.widget.class.php',
            'hw_simple_html_dom'       => HW_METASLIDER_PATH . 'inc/simple_html_dom.php'
        );
    ...
    private function setup_shortcode() {
        ...
        add_shortcode( 'hw_metaslider', array( $this, 'register_shortcode' ) );
        add_shortcode( 'hw-ml-slider', array( $this, 'register_shortcode' ) ); // backwards compatibility
    ...
    private function setup_actions() {
        ...
        add_action( 'hw_widgets_init', array( $this, 'register_metaslider_widget' ) );
    ...
    public function register_metaslider_widget() {
        ...
        register_widget( 'HW_MetaSlider_Widget' );
    ...
    public function register_post_type() {
        ...
        register_post_type( 'hw-ml-slider', array(
                'query_var' => false,
                'rewrite' => false,
                'public' => true,
    ...
    public function register_taxonomy() {
        ...
        register_taxonomy( 'hw-ml-slider', 'attachment', array(
                'hierarchical' => true,
                'public' => false,
                'query_var' => false,
                'rewrite' => false
    ...
    public function register_admin_menu() {
        ...
        $title = apply_filters( 'hw_metaslider_menu_title', 'Meta Slider' );

        $capability = apply_filters( 'hw_metaslider_capability', 'edit_others_posts' );

        $page = add_menu_page( $title, $title, $capability, 'hw-metaslider', array(
                $this, 'render_admin_page'
            ), HW_METASLIDER_ASSETS_URL . 'metaslider/slider-icon.png', 9501 );
        ...
        /*if ( ! is_plugin_active( 'ml-slider-pro/ml-slider-pro.php' ) && get_user_meta( $user_ID, "hw_metaslider_hide_go_pro", true ) !== 'true' ) {
    ...
    public function hide_go_pro_page() {
        ...
        if ( ! get_user_meta( $user_ID, "hw_metaslider_hide_go_pro" ) ) {
            add_user_meta( $user_ID, "hw_metaslider_hide_go_pro", "true" );
        }

        wp_redirect( admin_url( "admin.php?page=hw-metaslider" ) );
    ...
    public function register_shortcode( $atts ) {
        ...
        if ( ! $slider || $slider->post_status != 'publish' || $slider->post_type != 'hw-ml-slider' ) {
    ...
    public function help_tab() {
        ...
        $screen->add_help_tab( array(
                'id'    => 'documentation',
                'title' => __( 'Tài liệu', 'metaslider' ),
                'content'   => "<p><a href='http://www.metaslider.com/documentation/' target='blank'>Tài liệu Meta Slider</a></p>",
            )
        );
    ...
    public function register_admin_styles() {
        ...
        wp_enqueue_style( 'metaslider-admin-styles', HW_METASLIDER_ASSETS_URL . 'metaslider/admin.css', false, HW_METASLIDER_VERSION );
        wp_enqueue_style( 'metaslider-colorbox-styles', HW_METASLIDER_ASSETS_URL . 'colorbox/colorbox.css', false, HW_METASLIDER_VERSION );
        wp_enqueue_style( 'metaslider-tipsy-styles', HW_METASLIDER_ASSETS_URL . 'tipsy/tipsy.css', false, HW_METASLIDER_VERSION );
        
        do_action( 'hw_metaslider_register_admin_styles' );
    ...
    public function register_admin_scripts() {
        ...
        wp_enqueue_script( 'metaslider-colorbox', HW_METASLIDER_ASSETS_URL . 'colorbox/jquery.colorbox-min.js', array( 'jquery' ), HW_METASLIDER_VERSION );
        wp_enqueue_script( 'metaslider-tipsy', HW_METASLIDER_ASSETS_URL . 'tipsy/jquery.tipsy.js', array( 'jquery' ), HW_METASLIDER_VERSION );
        wp_enqueue_script( 'metaslider-admin-script', HW_METASLIDER_ASSETS_URL . 'metaslider/admin.js', array( 'jquery', 'metaslider-tipsy', 'media-upload' ), HW_METASLIDER_VERSION );
        ...
        do_action( 'hw_metaslider_register_admin_scripts' );
    ...
    public function localize_admin_scripts() {
        ...
        wp_localize_script( 'metaslider-admin-script', 'metaslider', array(
                ...
                'resize_nonce' => wp_create_nonce( 'hw_metaslider_resize' ),
                'addslide_nonce' => wp_create_nonce( 'hw_metaslider_addslide' ),
                'changeslide_nonce' => wp_create_nonce( 'hw_metaslider_changeslide' ),
    ...
    public function do_preview() {
        ...
        if ( isset( $_GET['slider_id'] ) && absint( $_GET['slider_id'] ) > 0 ) {
            ...
            <html>
                ...
                <body>
                    <?php echo do_shortcode("[hw_metaslider id={$id}]"); ?>
                    <?php wp_footer(); ?>
                </body>
            </html>
            <?php
    ...
    public function do_system_check() {
        ...
        $systemCheck = new HW_MetaSliderSystemCheck();
        $systemCheck->check();
    ...
    public function custom_media_uploader_tabs( $strings ) {
        ...
        //update strings
        if ( ( isset( $_GET['page'] ) && $_GET['page'] == 'hw-metaslider' ) ) {
    ...
    public function set_slider( $id, $shortcode_settings = array() ) {
        ...
        } else if ( $settings = get_post_meta( $id, 'hw-ml-slider_settings', true ) ) {
    ...
    private function create_slider( $type, $id, $shortcode_settings ) {
        ...
        switch ( $type ) {
            case( 'coin' ):
                return new HW_MetaCoinSlider( $id, $shortcode_settings );
            case( 'flex' ):
                return new HW_MetaFlexSlider( $id, $shortcode_settings );
            case( 'nivo' ):
                return new HW_MetaNivoSlider( $id, $shortcode_settings );
            case( 'responsive' ):
                return new HW_MetaResponsiveSlider( $id, $shortcode_settings );
            default:
                return new HW_MetaFlexSlider( $id, $shortcode_settings );
    ...
    public function switch_view() {
        ...
        delete_user_meta( $user_ID, "hw_metaslider_view" );

        if ( $view == 'dropdown' ) {
            add_user_meta( $user_ID, "hw_metaslider_view", "dropdown");
        }
    ...
    public function all_meta_sliders( $sort_key = 'date' ) {
        ...
        $args = apply_filters( 'hw_metaslider_all_meta_sliders_args', $args );
    ...
    public function build_settings_rows( $aFields ) {
        ...
        foreach ( $aFields as $id => $row ) {
            ...
            if ( $row['type'] == 'navigation' ) {
                ...
                $return .= apply_filters( 'hw_metaslider_navigation_options', $navigation_row, $this->slider );
            }
            ...
            if ( $row['type'] == 'theme' ) {
                ...
                $return .= apply_filters( 'hw_metaslider_get_available_themes', $themes, $this->slider->get_setting( 'theme' ) );
    ...
    public function print_slideshow_selector() {
        ...
        $add_url = wp_nonce_url( "?page=hw-metaslider&amp;add=true", "metaslider_add_slider" );
            ...
            if ( $this->get_view() == 'tabs' ) {
                ...
                foreach ( $tabs as $tab ) {
                    ...
                    if ( $tab['active'] ) {
                        ...
                        echo "<a href='?page=hw-metaslider&amp;id={$tab['id']}' class='nav-tab'>" . esc_html( $tab['title'] ) . "</a>";
                    }
                ...
                foreach ( $tabs as $tab ) {
                    ...
                    echo "<option value='?page=hw-metaslider&amp;id={$tab['id']}'{$selected}>{$tab['title']}</option>";
    ...
    public function get_view() {
        ...
        if ( get_user_meta( $user_ID, "hw_metaslider_view", true ) ) {
            return get_user_meta( $user_ID, "hw_metaslider_view", true );
        }
    ...
    public function render_admin_page() {
        ...
        <div class="wrap metaslider">
            <form accept-charset="UTF-8" action="?page=hw-metaslider&amp;id=<?php echo $slider_id ?>" method="post">
                <?php
                    if ( $this->slider ) {
                        ...
                        <div id="postbox-container-1" class="postbox-container">
                            <div class='right'>
                                ...
                                <div class="ms-postbox shortcode ms-toggle" id="metaslider_usage">
                                    <div class="handlediv" title="Click to toggle"><br></div><h3 class="hndle"><span><?php _e( "Cách sử dụng", "metaslider" ) ?></span></h3>
                                    <div class="inside">
                                        <ul class='tabs'>
                                            <li rel='tab-1' class='selected'><?php _e( "Shortcode", "metaslider" ) ?></li>
                                            <li rel='tab-2'><?php _e( "PHP", "metaslider" ) ?></li>
                                        </ul>
                                        <div class='tabs-content'>
                                            <div class='tab tab-1'>
                                            <p><?php _e( "Hiển thị slider với shortcode sau.", "metaslider" ); ?></p>
                                            <input readonly='readonly' type='text' value='[hw_metaslider id=<?php echo $this->slider->id ?>]' /></div>
                                            <div class='tab tab-2' style='display: none'>
                                            <p><?php _e( "Gọi shortcode với hàm PHP trong template:", "metaslider" ); ?></p>
                                            <textarea readonly='readonly'>&lt;?php &#13;&#10;    echo do_shortcode("[hw_metaslider id=<?php echo $this->slider->id ?>]"); &#13;&#10;?></textarea></div>
                                        </div>
                                    </div>
                                </div>


                                <a class='delete-slider alignright button-secondary' href='<?php echo wp_nonce_url( "?page=hw-metaslider&amp;delete={$this->slider->id}", "metaslider_delete_slider" ); ?>'><?php _e( "Delete Slider", "metaslider" ) ?></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    public function insert_metaslider_button( $context ) {
        ...
        if ( in_array( $pagenow, array( 'post.php', 'page.php', 'post-new.php', 'post-edit.php' ) ) ) {
            $context .= '<a href="#TB_inline?&inlineId=choose-meta-slider" class="thickbox button" title="' .
                ...
                '"><span class="wp-media-buttons-icon" style="background: url(' . HW_METASLIDER_ASSETS_URL .
                '/metaslider/slider-icon.png); background-repeat: no-repeat; background-position: left bottom;"></span> ' .
    ...
    /*public function upgrade_to_pro_cta() {
        ...
        if ( function_exists( 'is_plugin_active' ) && ! is_plugin_active( 'ml-slider-pro/ml-slider-pro.php' ) ) {
            ...
            $text = "Meta Slider v" . HW_METASLIDER_VERSION . " - " . __( 'Upgrade to Pro $19', "metaslider" );
    ...
    public function resource_manager( $buffer ) {
        ...
        $selectors = apply_filters( "hw_metaslider_resource_manager_selectors", $selectors );
...
//add_action( 'plugins_loaded', array( 'HW_MetaSliderPlugin', 'init' ), 10 );
add_action( 'hw_plugins_loaded', array( 'hw__metaslider', 'init' ), 10 );
