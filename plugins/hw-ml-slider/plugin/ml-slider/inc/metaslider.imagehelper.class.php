 ...
 */
class HW_MetaSliderImageHelper {
    ...
    function get_image_url( $force_resize = false ) {
        ...
        if ( ! strlen( $this->path ) ) {
            return apply_filters( 'hw_metaslider_resized_image_url', $this->url, $this->url );
        }
        ...
        $dest_url = apply_filters( 'hw_metaslider_resized_image_url', $dest_url, $this->url );
    ...
    private function get_crop_position() {
        ...
        $crop_position = get_post_meta( $this->id, 'hw-ml-slider_crop_position', true );
