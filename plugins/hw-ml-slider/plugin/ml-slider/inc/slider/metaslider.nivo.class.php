 ...
 */
class HW_MetaNivoSlider extends HW_MetaSlider {
    ...
    public function __construct( $id, $shortcode_settings ) {
        ...
        add_filter( 'hw_metaslider_nivo_slider_parameters', array( $this, 'set_autoplay_parameter' ), 10, 3 );
    }
    ...
    public function set_autoplay_parameter( $options, $slider_id, $settings ) {
        ...
        remove_filter( 'hw_metaslider_nivo_slider_parameters', array( $this, 'set_autoplay_parameter' ), 10, 3 );
    ...
    protected function get_html() {
        ...
        return apply_filters( 'hw_metaslider_nivo_slider_get_html', $return_value, $this->id, $this->settings );;
    }
}