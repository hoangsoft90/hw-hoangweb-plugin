 ...
 * Time: 15:47
 */
class HW_Module_Config_visualeditor extends HW_Config_Module_Section{
    /**
     * @return mixed|void
     */
    function start() {
    ...
    public function content($aField) {
        ...
        <script>
            __hw_installer.load_module_commands('vse', '<?php echo $this->get_current_module()->option('module_name')?>',{
            ...
            jQuery(document).ready(function(){
                ...
                //__hw_installer.get_commands('vse').view_stats([]);
            });

        </script>
        <br/>
        <div class="buttons-container">
            <a class="button" onclick="__hw_installer.get_commands('vse').create_widget(this)" href="javascript:void(0)">add widget</a>

        </div>
    <?php
    }
}
HW_Module_Config_visualeditor::register_config_page();