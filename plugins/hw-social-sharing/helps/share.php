 ...
 * HW_HELP_SHARE class
 */
class HW_HELP_SHARE extends HW_HELP{
    ...
    public function register_admin_menu(){
        ...
        $this->add_help_content(self::load_current_page_hook_slug() ,'hwss',"Chia sẻ");
        #_print();
        //self::load_settings_page_hook_slug(HW_SocialsShare_Settings::SETTINGS_PAGE_SLUG)
    }
