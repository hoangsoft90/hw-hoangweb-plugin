...
/**
 * Class HW_Module_Config_weather_rexr
 */
class HW_Module_Config_weather_rexr extends HW_Config_Module_Section{
    /**
     * @return mixed|void
     */
    function start() {
    ...
    public function content($aField) {
        ...
        <script>
            __hw_installer.load_module_commands('wea_exr', '<?php echo $this->get_current_module()->option('module_name')?>',{
            ...
            jQuery(document).ready(function(){
                ...
                //__hw_installer.get_commands('wea_exr').view_stats([]);
            });

        </script>
        <br/>
        <div class="buttons-container">
            <a class="button" onclick="__hw_installer.get_commands('wea_exr').create_widget(this)" href="javascript:void(0)">Create widget</a>

        </div>
    <?php
    }
}
HW_Module_Config_weather_rexr::register_config_page();