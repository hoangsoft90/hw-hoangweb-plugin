<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo HWTPL_PLUGIN_URL.('/css/basic.css'); ?>">
        <script type="text/javascript" src="<?php echo includes_url(); ?>js/tinymce/tiny_mce_popup.js"></script>         
        <script type="text/javascript" src="<?php echo includes_url(); ?>js/jquery/jquery.js"></script>
        <script type="text/javascript" src="<?php echo HWTPL_PLUGIN_URL.('/js/dialog_box.js'); ?>"></script>
        <script type="text/javascript" src="<?php echo HWTPL_PLUGIN_URL.('/js/jquery.validate.js'); ?>"></script>
          
        <?php
        if(floatval(get_bloginfo("version")) > floatval("3.5.2"))
        {
        ?>
            <script type="text/javascript" src="<?php echo HWTPL_PLUGIN_URL.('/js/jquery-migrate.js'); ?>"></script>
        <?php
        }
        ?>
    </head>
