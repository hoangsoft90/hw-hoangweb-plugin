 ...
 */
class HW_Gallery_Common_Admin_Lite {
    ...
    public function delete_gallery_association( $attach_id ) {
        ...
        if ( ! empty( $has_gallery ) ) {
            foreach ( (array) $has_gallery as $post_id ) {
                ...
                HW_Gallery_Common_Lite::get_instance()->flush_gallery_caches( $post_id, ( ! empty( $gallery_data['config']['slug'] ) ? $gallery_data['config']['slug'] : '' ) );
            }
        }
     ...
     * @since 1.0.0
     *
     * @return object The HW_Gallery_Common_Admin_Lite object.
     */
    public static function get_instance() {

        if ( ! isset( self::$instance ) && ! ( self::$instance instanceof HW_Gallery_Common_Admin_Lite ) ) {
            self::$instance = new HW_Gallery_Common_Admin_Lite();
        }
...
$hw_gallery_common_admin_lite = HW_Gallery_Common_Admin_Lite::get_instance();