...
class HW_Wpcf_settings extends AdminPageFramework{
     ...
     */
    public function load_hw_wpcf7_settings( $oAdminPage ) {
        ...
        $this->addSettingSections(
                'hw_wpcf7_settings',    //must match with page slug
                array(
                        'section_id' => 'general',
                        'title' => 'Cài đặt',
