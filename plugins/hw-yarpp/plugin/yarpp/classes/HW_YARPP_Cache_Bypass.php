...
class HW_YARPP_Cache_Bypass extends HW_YARPP_Cache {
    ...
    public function demo_request_filter($arg) {
        ...
        return
            "SELECT
		        ...
		        concat('".__('Example post ','hw-yarpp')."', @count:=@count+1) as post_title,
		        0 as post_category,
		        '' as post_excerpt,
    ...
    public function related($reference_ID = null, $related_ID = null) {
        ...
        if ( is_int($related_ID) && is_null($reference_ID) ) {
            _doing_it_wrong( __METHOD__, 'HW_YARPP_Cache_Bypass::related cannot do a reverse lookup', '3.4' );
            return;
        }
