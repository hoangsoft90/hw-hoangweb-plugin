...
class HW_YARPP_Meta_Box_Optin extends HW_YARPP_Meta_Box {
    public function display() {
        $output =
            ...
            '<br/><br/>'.
            '<a href="'.plugins_url('/', dirname(__FILE__)).'includes/hw_yarpp_switch.php" class="hw_yarpp_switch_button button" data-go="pro">Turn them on now</a>&nbsp;&nbsp;'.
            ...
            '<input
                ...
                name="optin"
                value="true" '.
            checked(hw_yarpp_get_option('optin') == 1 ,true, false).' '.
            '/>'.
