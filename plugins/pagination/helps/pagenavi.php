...
class HW_HELP_PAGENAVI extends HW_HELP{
    ...
    function register_admin_menu(){
        ...
        //add_action( self::load_settings_page_hook_slug('pagenavi') , array( $this, 'help_tab' ) );
        $this->add_help_content( self::load_settings_page_hook_slug('pagenavi') );  //new approach
    }
