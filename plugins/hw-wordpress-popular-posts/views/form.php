...
<p>
	<label for="<?php echo $this->get_field_id("skin"); ?>">
		...
		<?php $this->skin->get_skins_select_tag('skin',array('class'=>'widefat'))?>
	</label>
</p>
<?php }?>