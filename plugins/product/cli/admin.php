...
if ( ! defined( 'ABSPATH' ) )
    exit;
/**
 * Class HW_Module_Config_Product
 */
class HW_Module_Config_Product extends HW_Config_Module_Section{
    /**
     * @return mixed|void
     */
    function start() {
    ...
    public function content($aField) {
        ...
        <script>
            __hw_installer.load_module_commands('product', '<?php echo $this->get_current_module()->option('module_name')?>',{
            ...
            jQuery(document).ready(function(){
                ...
                //__hw_installer.get_commands('product').view_stats([]);
            });

        </script>
        <br/>
        <div class="buttons-container">
            <a class="button" onclick="__hw_installer.get_commands('product').config_settings(this)" href="javascript:void(0)">setting page</a>

        </div>
    <?php
    }
}
HW_Module_Config_Product::register_config_page();